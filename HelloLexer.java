...
public class HelloLexer extends Lexer {
	...
	public final void mTIPOS() throws RecognitionException {
		try {
			int _type = TIPOS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Hello.g:381:2: ( ( 'int' | 'float' | 'string' ) )
			// Hello.g:381:4: ( 'int' | 'float' | 'string' )
			{
			// Hello.g:381:4: ( 'int' | 'float' | 'string' )
			int alt1=3;
			switch ( input.LA(1) ) {
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Hello.g:385:2: ( 'A' .. 'Z' ( 'A' .. 'Z' | '0' .. '9' )* )
			// Hello.g:385:4: 'A' .. 'Z' ( 'A' .. 'Z' | '0' .. '9' )*
			{
			matchRange('A','Z'); 
			// Hello.g:385:15: ( 'A' .. 'Z' | '0' .. '9' )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mTEXTO() throws RecognitionException {
		try {
			int _type = TEXTO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Hello.g:393:2: ( '\"' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | ' ' | '!' | '_' | '-' )* '\"' )
			// Hello.g:393:4: '\"' ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | ' ' | '!' | '_' | '-' )* '\"'
			{
			match('\"'); 
			// Hello.g:393:8: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | ' ' | '!' | '_' | '-' )*
			loop4:
			while (true) {
				int alt4=2;
	...
	public final void mNUMERO() throws RecognitionException {
		try {
			int _type = NUMERO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Hello.g:397:2: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
			// Hello.g:397:4: ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
			{
			// Hello.g:397:4: ( '0' .. '9' )+
			int cnt5=0;
			loop5:
